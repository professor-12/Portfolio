  ...
  return (
    <section className='flex flex-col md:flex-row  my-[12rem] items-center justify-between'>
        <div className='md:w-1/2'>
            <h1 className='md:text-3xl text-center text-lg text-slate-400'>Frontend developer.</h1>
            <p className='md:text-5xl text-center text-xl  mt-5 font-semibold '>Hello!, I'm <span className='text-red-600'>Emmanuel</span> Badejo </p>
        </div>
